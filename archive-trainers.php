          ...
          <ul class="trainers-list">
            ...
            <li class="trainers-list__item">
              <article class="trainer">
                <img src="<?php echo get_field('trainers_photo')['url']; ?>" alt="<?php echo get_field('trainers_photo')['alt']; ?>" class="trainer__thumb">
                <div class="trainer__wrap">
                  <h2 class="trainer__name"> <?php the_title(); ?> </h2>
                  <p class="trainer__text"> <?php the_field('trainers_descr'); ?> </p>
                </div>
